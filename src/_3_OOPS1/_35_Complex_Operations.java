...
public class _35_Complex_Operations {
    public class ComplexNumber{
        ...
        public void add(double xReal, double xImaginary){
            real += xReal;
            imaginary += xImaginary;
        }

        public void add (ComplexNumber xy){
            add(xy.getReal(), xy.getImaginary());
        }

        public void subtract(double xReal, double xImaginary){
            real -= xReal;
            imaginary -= xImaginary;
        }
        public void subtract(ComplexNumber xy){
            subtract(xy.getReal(), xy.getImaginary());
        }
