...
public class _33_Point {
    private int x;
    private int y;

    public void _33_Point() {

    }

    public void _33_Point(int x, int y) {
        this.x = x;
        this.y = y;
    }
    ...
    public double distance(Point another) {
        return Math.sqrt((getX() - another.x) * (getX() - another.getX()) + (getY() - another.getY()) * (getY() - another.getY()));
    }
